...
export default function TopContent() {
  return (
    ...
    >
      ...
      >
        <div
          className={`text-[#0C111D] font-bold text-2xl font-br-firma`}
        >
          Welcome Susan,
        </div>
        <p
          className="text-[#344054] font-normal font-aeonik-pro text-base"
        >
      ...
      >
        <p
          className="text-[#101828] leading-5 font-aeonik-pro text-sm"
        >
          Welcome to the cool kids club
        </p>

        <p
          className="text-[#4A24A1] leading-8 text-xl md:text-2xl font-medium font-aeonik-pro"
        >
